...
public class Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 0:return new LinearViewHolder_0(LayoutInflater.from(mContext).inflate(R.layout.activity_inform_view_item_0, parent, false));
            default:return new LinearViewHolder_1(LayoutInflater.from(mContext).inflate(R.layout.activity_inform_view_item_1, parent, false));
        }
    }
...
//        });
    ...
    class LinearViewHolder_0 extends RecyclerView.ViewHolder {
        ...
        //声明布局中的控件
        //private ImageView mIv_info_flower;

        public LinearViewHolder_0(View itemView) {
            super(itemView);
            //因为这个textVIew在itemView这个布局当中  所以用它来fdvc
            //mIv_info_flower = (ImageView)itemView.findViewById(R.id.iv_info_flower);
